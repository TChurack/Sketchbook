# Ruby script to sum a series of integers (decimals will have only their whole number part considered) that are given as command line arguments in the form: >ruby sumScript.rb 1 2 3 4
